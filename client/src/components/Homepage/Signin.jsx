    ...
    <>
      <div className="bg-[#EEEEEE] rounded-lg w-fit h-fit z-20 absolute top-0 left-0 right-0 bottom-0 m-auto flex-column justify-center items-center pl-16 pb-16 pr-16 pt-6">
        ...
        <div className="p-4">
          ...
          {
            loading ? <>        <div className="flex justify-center flex-col"><span className="">Please wait the server hosted on <a href="https://render.com/">Render</a> server might be booting up :) free services</span><img src={loadingGIF} className="w-[100px]" alt="Loading-Gif" /></div>
